...
public class InstanceScopeActorProtocol {
  
  // Create a Terracotta root that holds all actors
  private static final Map<String, Object> ACTORS; 
  static {
    ManagerUtil.beginLock("SCALA_ACTORS_ROOT_INSTANCE_SCOPE", Manager.LOCK_TYPE_WRITE);    
    try {
      ACTORS = (Map<String, Object>)ManagerUtil.lookupOrCreateRoot("SCALA_ACTORS_INSTANCE_SCOPE", new HashMap<String, Object>());
    } finally {
      ManagerUtil.commitLock("SCALA_ACTORS_ROOT_INSTANCE_SCOPE");      
    }   
  }
